...
//// jwc 25-1126-2200 OPTION 1 ARCHIVED 25-1202-2030: ESP32 POSTs to Python Server via HTTP
...
#include <WiFi.h>
#include <HTTPClient.h>  // Still needed for sendVideoFrame function
#include <WiFiClient.h>  // Still needed for sendVideoFrame function
...
//// jwc 25-1202-2030 ARCHIVED HTTP POST function (replaced with WebSocket):
...
bool sendAprilTagDataWebSocket(int tag_id, const char* camera_name, float yaw, float pitch, float roll,  
...
void setup()
{
    ...
    if (wifi_connected) {
        ...
        printf("✅ WebSocket client initialized (connecting...)\n");
    } else {
        printf("❌ WiFi not connected - WebSocket initialization skipped\n");
    }
}
...
//// jwc 25-1203-0040 http //// jwc 25-1126-2200 OPTION 1: Real-time HTTP POST (ACTIVE)
//// jwc 25-1203-0040 http bool sendAprilTagData(int tag_id, const char* camera_name, float yaw, float pitch, float roll, 
//// jwc 25-1203-0040 http                       float x_cm, float y_cm, float z_cm, float tag_size_percent, float distance_cm) {
//// jwc 25-1203-0040 http     // Check WiFi connection status
//// jwc 25-1203-0040 http     if (!wifi_connected || WiFi.status() != WL_CONNECTED) {
//// jwc 25-1203-0040 http         printf("*** HTTP ERROR: WiFi not connected (wifi_connected=%d, WiFi.status()=%d)\n", 
//// jwc 25-1203-0040 http                wifi_connected, WiFi.status());
//// jwc 25-1203-0040 http         return false;
//// jwc 25-1203-0040 http     }
//// jwc 25-1203-0040 http     
//// jwc 25-1203-0040 http     unsigned long current_time = millis();
//// jwc 25-1203-0040 http     
//// jwc 25-1203-0040 http     // Start latency measurement
//// jwc 25-1203-0040 http     unsigned long latency_start_ms = millis();
//// jwc 25-1203-0040 http     
//// jwc 25-1203-0040 http     printf("\nvvv HTTP POST START vvv\n");
//// jwc 25-1203-0040 http     printf("*** HTTP: Target URL: %s\n", client_e32__http_post_to_serverhub__smartcam_april_tag_URL);
//// jwc 25-1203-0040 http     printf("*** HTTP: Tag ID: %d, Camera: %s\n", tag_id, camera_name);
//// jwc 25-1203-0040 http     
//// jwc 25-1203-0040 http     //// jwc 25-1130-0400 OLD METHOD (SSL error -29312 with HTTPS):
//// jwc 25-1203-0040 http     //// jwc 25-1130-0400 HTTPClient http;
//// jwc 25-1203-0040 http     //// jwc 25-1130-0400 http.begin(client_e32__http_post_to_serverhub__smartcam_april_tag_URL);
//// jwc 25-1203-0040 http     //// jwc 25-1130-0400 http.addHeader("Content-Type", "application/json");
//// jwc 25-1203-0040 http     
//// jwc 25-1203-0040 http     //// jwc 25-1130-0410 ARCHIVED: WiFiClientSecure for HTTPS - caused SSL error with HTTP:
//// jwc 25-1203-0040 http     //// jwc 25-1130-0410 WiFiClientSecure *client = new WiFiClientSecure;
//// jwc 25-1203-0040 http     //// jwc 25-1130-0410 if (!client) {
//// jwc 25-1203-0040 http     //// jwc 25-1130-0410     printf("*** HTTP ERROR: Failed to allocate WiFiClientSecure\n");
//// jwc 25-1203-0040 http     //// jwc 25-1130-0410     return false;
//// jwc 25-1203-0040 http     //// jwc 25-1130-0410 }
//// jwc 25-1203-0040 http     //// jwc 25-1130-0410 client->setInsecure();  // Skip SSL certificate verification for HTTPS (ngrok)
//// jwc 25-1203-0040 http     
//// jwc 25-1203-0040 http     //// jwc 25-1130-1100 Use WiFiClient for HTTP (not HTTPS):
//// jwc 25-1203-0040 http     WiFiClient *client = new WiFiClient;
//// jwc 25-1203-0040 http     if (!client) {
//// jwc 25-1203-0040 http         printf("*** HTTP ERROR: Failed to allocate WiFiClient\n");
//// jwc 25-1203-0040 http         return false;
//// jwc 25-1203-0040 http     }
//// jwc 25-1203-0040 http     
//// jwc 25-1203-0040 http     HTTPClient http;
//// jwc 25-1203-0040 http     http.begin(*client, client_e32__http_post_to_serverhub__smartcam_april_tag_URL);
//// jwc 25-1203-0040 http     http.addHeader("Content-Type", "application/json");
//// jwc 25-1203-0040 http     http.addHeader("Access-Control-Allow-Origin", "*");
//// jwc 25-1203-0040 http     http.addHeader("Access-Control-Allow-Methods", "POST, GET, OPTIONS");
//// jwc 25-1203-0040 http     http.addHeader("Access-Control-Allow-Headers", "Content-Type");
//// jwc 25-1203-0040 http     
//// jwc 25-1203-0040 http         // Create JSON payload with all AprilTag data + ESP32 queue status
//// jwc 25-1203-0040 http         String json_payload = "{";
//// jwc 25-1203-0040 http         json_payload += "\"smartcam_ip\":\"" + WiFi.localIP().toString() + "\",";
//// jwc 25-1203-0040 http         json_payload += "\"tag_id\":" + String(tag_id) + ",";
//// jwc 25-1203-0040 http         json_payload += "\"yaw\":" + String(yaw, 1) + ",";
//// jwc 25-1203-0040 http         json_payload += "\"pitch\":" + String(pitch, 1) + ",";
//// jwc 25-1203-0040 http         json_payload += "\"roll\":" + String(roll, 1) + ",";
//// jwc 25-1203-0040 http         json_payload += "\"x_cm\":" + String(x_cm, 1) + ",";
//// jwc 25-1203-0040 http         json_payload += "\"y_cm\":" + String(y_cm, 1) + ",";
//// jwc 25-1203-0040 http         json_payload += "\"z_cm\":" + String(z_cm, 1) + ",";
//// jwc 25-1203-0040 http         json_payload += "\"tag_size_percent\":" + String(tag_size_percent, 1) + ",";
//// jwc 25-1203-0040 http         json_payload += "\"distance_cm\":" + String(distance_cm, 1) + ",";
//// jwc 25-1203-0040 http         json_payload += "\"esp32_queue_count\":" + String(list_count) + ",";  // ESP32 queue status for lag monitoring
//// jwc 25-1203-0040 http         json_payload += "\"camera_name\":\"" + String(camera_name) + "\",";
//// jwc 25-1203-0040 http         json_payload += "\"timestamp\":" + String(current_time);
//// jwc 25-1203-0040 http         json_payload += "}";
//// jwc 25-1203-0040 http     
//// jwc 25-1203-0040 http     printf("*** HTTP: Sending JSON payload: %s\n", json_payload.c_str());
//// jwc 25-1203-0040 http     printf("*** HTTP: Payload size: %d bytes\n", json_payload.length());
//// jwc 25-1203-0040 http     
//// jwc 25-1203-0040 http     int httpResponseCode = http.POST(json_payload);
//// jwc 25-1203-0040 http     
//// jwc 25-1203-0040 http     // End latency measurement
//// jwc 25-1203-0040 http     unsigned long latency_end_ms = millis();
//// jwc 25-1203-0040 http     unsigned long latency_ms = latency_end_ms - latency_start_ms;
//// jwc 25-1203-0040 http     
//// jwc 25-1203-0040 http     if (httpResponseCode > 0) {
//// jwc 25-1203-0040 http         String response = http.getString();
//// jwc 25-1203-0040 http         
//// jwc 25-1203-0040 http         // Update latency statistics on successful request
//// jwc 25-1203-0040 http         network_latency.update(latency_ms);
//// jwc 25-1203-0040 http         
//// jwc 25-1203-0040 http         printf("*** HTTP SUCCESS: Response Code: %d\n", httpResponseCode);
//// jwc 25-1203-0040 http         printf("*** HTTP SUCCESS: Server Response: %s\n", response.c_str());
//// jwc 25-1203-0040 http         printf("*** HTTP LATENCY: Current=%lums, Min=%lums, Max=%lums, Avg=%lums (Count=%lu)\n",
//// jwc 25-1203-0040 http                latency_ms,
//// jwc 25-1203-0040 http                network_latency.min_us / 1000,
//// jwc 25-1203-0040 http                network_latency.max_us / 1000,
//// jwc 25-1203-0040 http                network_latency.getAverage() / 1000,
//// jwc 25-1203-0040 http                network_latency.count);
//// jwc 25-1203-0040 http         printf("^^^ HTTP POST END (SUCCESS) ^^^\n\n");
//// jwc 25-1203-0040 http         
//// jwc 25-1203-0040 http         // Show success on display with latency
//// jwc 25-1203-0040 http         gfx->setTextSize(1);
//// jwc 25-1203-0040 http         gfx->setCursor(180, 1);
//// jwc 25-1203-0040 http         gfx->printf("HTTP:%lums", latency_ms);
//// jwc 25-1203-0040 http         
//// jwc 25-1203-0040 http         http.end();  // End HTTP connection first
//// jwc 25-1203-0040 http         delete client;  // Clean up WiFiClient
//// jwc 25-1203-0040 http         return true;
//// jwc 25-1203-0040 http     } else {
//// jwc 25-1203-0040 http         printf("*** HTTP FAILURE: Error Code: %d\n", httpResponseCode);
//// jwc 25-1203-0040 http         printf("*** HTTP FAILURE: Possible causes:\n");
//// jwc 25-1203-0040 http         printf("    - Server not running on %s\n", client_e32__http_post_to_serverhub__smartcam_april_tag_URL);
//// jwc 25-1203-0040 http         printf("    - Network connectivity issues\n");
//// jwc 25-1203-0040 http         printf("    - Firewall blocking port 5000\n");
//// jwc 25-1203-0040 http         printf("^^^ HTTP POST END (FAILED) ^^^\n\n");
//// jwc 25-1203-0040 http         
//// jwc 25-1203-0040 http         // Show error on display
//// jwc 25-1203-0040 http         gfx->setTextSize(1);
//// jwc 25-1203-0040 http         gfx->setCursor(200, 1);
//// jwc 25-1203-0040 http         gfx->printf("HTTP:ERR");
//// jwc 25-1203-0040 http         
//// jwc 25-1203-0040 http         http.end();  // End HTTP connection first
//// jwc 25-1203-0040 http         delete client;  // Clean up WiFiClient
//// jwc 25-1203-0040 http         return false;
