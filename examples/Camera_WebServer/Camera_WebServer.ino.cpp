...
void setup()
{
    ...
    //// jwc
    Serial.println("*** Hi Jesus!");

    //// jwc 25-0607-0900
    Serial.printf("Heap before camera: %u, PSRAM: %u\n", ESP.getFreeHeap(), ESP.getFreePsram());

    OV2640_Initialization();

    //// jwc 25-0607-0900
    Serial.printf("Heap after camera: %u, PSRAM: %u\n", ESP.getFreeHeap(), ESP.getFreePsram());

    ////jwc Following causes JtagDebugger to break down from stepping
    ...
    //// jwc 25-0607-0900
    Serial.printf("Heap after WiFi: %u, PSRAM: %u\n", ESP.getFreeHeap(), ESP.getFreePsram());
